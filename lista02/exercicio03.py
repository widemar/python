...
peso = float(input('Quantidade em KGs de peixe: '))
...
if peso > 50:
    excesso = peso - 50
    multa = excesso * 4
    print('PESO ACIMA DO PERMITIDO. Excesso de %.2f KGs, valor da multa R$ %.2f.' %(excesso, multa))
else:
    print('PESO ABAIXO DO PERMITIDO. Excesso de %.2f KGs, valor da multa R$ %.2f R$.' % (excesso, multa))
